...
<script>
  export default {
    ...
    methods: {
      ...
      setMenuIcons() {
        this.menuIconAboutMe = this.$refs.menuIconAboutMe;
        this.menuIconAboutMe.innerHTML = this.aboutmeSVG;
        this.menuIconContactMe = this.$refs.menuIconContactMe;
        this.menuIconContactMe.innerHTML = this.contactmeSVG;
        this.menuIconHome = this.$refs.menuIconHome;
        this.menuIconHome.innerHTML = this.homeSVG;
        this.menuIconResume = this.$refs.menuIconResume;
        this.menuIconResume.innerHTML = this.resumeSVG;
      }
    },
    mounted() {
      this.initialize();
